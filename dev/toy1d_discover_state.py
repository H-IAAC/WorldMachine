...
if __name__ == "__main__":
    ...
    toy1d_parameter_variation = {
        ...
        "Discover1_MM_TRAIN_M": {"discover_state": True, "stable_state_epochs": 1, "block_configuration": [Dimensions.MEASUREMENT, Dimensions.MEASUREMENT], "sensorial_train_losses": {Dimensions.MEASUREMENT}},
        "Discover1_MM_TRAIN_M_3M": {"discover_state": True, "stable_state_epochs": 1, "block_configuration": [Dimensions.MEASUREMENT, Dimensions.MEASUREMENT], "sensorial_train_losses": {Dimensions.MEASUREMENT}, "measurement_size": 3},
        ...
        "Discover1_DM": {"discover_state": True, "stable_state_epochs": 1, "block_configuration": [Dimensions.STATE_DECODED, Dimensions.MEASUREMENT]},
        "Discover1_DM_TRAIN_M": {"discover_state": True, "stable_state_epochs": 1, "block_configuration": [Dimensions.STATE_DECODED, Dimensions.MEASUREMENT], "sensorial_train_losses": {Dimensions.MEASUREMENT}},
        ...
        "Discover1_DM_MASKLINEARD": {"discover_state": True, "stable_state_epochs": 1, "block_configuration": [Dimensions.STATE_DECODED, Dimensions.MEASUREMENT], "mask_sensorial_data": {"state_decoded": LinearScheduler(0.0, 1.0, n_epoch)}},
