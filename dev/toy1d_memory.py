...
if __name__ == "__main__":
    ...
    toy1d_parameter_variation = {
        ...
        # "Break1_M0-100_FF_H0x_SS256_Alibi_SCheckSensorial_Head8_MMM_STR5F5P-MD": {"block_configuration": [Dimensions.NEXT_MEASUREMENT, Dimensions.NEXT_MEASUREMENT], "short_time_recall": set([Dimensions.NEXT_MEASUREMENT, Dimensions.STATE_DECODED]), "recall_n_past": 5, "recall_n_future": 5, "n_attention_head": 8, "check_input_masks": True, "positional_encoder_type": "alibi", "state_size": 256, "discover_state": True, "n_segment": 2, "mask_sensorial_data": UniformScheduler(0, 1, n_epoch), "fast_forward": True, "measurement_shift": 0, "sensorial_train_losses": [Dimensions.NEXT_MEASUREMENT]},
        ...
        # "Break1_M0-100_FF_H0x_SS128_Alibi_SCheckSensorial_Head4_STR5F5PStride3F3P-MD": {"recall_stride_past": 3, "recall_stride_future": 3, "short_time_recall": set([Dimensions.NEXT_MEASUREMENT, Dimensions.STATE_DECODED]), "recall_n_past": 5, "recall_n_future": 5, "n_attention_head": 4, "check_input_masks": True, "positional_encoder_type": "alibi", "state_size": 128, "discover_state": True, "n_segment": 2, "mask_sensorial_data": UniformScheduler(0, 1, n_epoch), "fast_forward": True, "measurement_shift": 0, "sensorial_train_losses": [Dimensions.NEXT_MEASUREMENT]},

        # "H0x_SS128_Sine_Head4": {"n_attention_head": 4, "positional_encoder_type": "sine", "state_size": 128, "discover_state": True, "measurement_shift": 0, "sensorial_train_losses": [Dimensions.NEXT_MEASUREMENT]},
        # "Break1_M0-100_FF_H0x_SS128_Sine_SCheckSensorial_Head4_STR5F5PStride3F3P-MD": {"recall_stride_past": 3, "recall_stride_future": 3, "short_time_recall": set([Dimensions.NEXT_MEASUREMENT, Dimensions.STATE_DECODED]), "recall_n_past": 5, "recall_n_future": 5, "n_attention_head": 4, "check_input_masks": True, "positional_encoder_type": "sine", "state_size": 128, "discover_state": True, "n_segment": 2, "mask_sensorial_data": UniformScheduler(0, 1, n_epoch), "fast_forward": True, "measurement_shift": 0, "sensorial_train_losses": [Dimensions.NEXT_MEASUREMENT]},
